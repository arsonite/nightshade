...
public class Blood {
	...
	final String[] bldHlt = { "Pure", "Healthy", "Polluted", "Infected", "Ill", "Incurable", "Fatal", "Occult",
			"Mutated" };
	private int state;
	...
	// TODO: Integration into status object + chance to bleed on hit, based on armor
	// and damage
