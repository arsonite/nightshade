...
public class Item extends Asset {
	...
	public void setUsability(boolean destr, boolean protec, boolean sell, boolean repair, boolean ench, boolean equip,
			boolean loot, boolean mov, boolean ownd, boolean cruc) {
		bool[0] = destr;
		bool[1] = protec;
		bool[2] = sell;
		bool[3] = repair;
	...
	public String getEquipName() {
		return (String) eq.getFirst();
	}

	public String getRarityName() {
		return (String) rare.getFirst();
	}
	...
	public String[] getTypes() {
		return Array.fromTeaType(Asset_Init.ITEM(true).get(0));
	}

	public String[] getRarities() {
		return Array.fromTeaType(Asset_Init.ITEM(true).get(1));
	}

	public int getEquipCode() {
		return (int) eq.getSecond();
	}

	public int getRarityNumber() {
		return (int) rare.getSecond();
	}
	...
	public BiPrimitive getEquip() {
		return eq;
	}

	public BiPrimitive getRarity() {
		return rare;
	}

	public BiPrimitive[] getAllValues() {
		return vals;
	}

	public BiPrimitive[] getAllDamageStats() {
		return dmgStats;
	}

	public BiPrimitive[] getUsability() {
		return use;
	}

	public TeaType<Status> getStatus() {
		return sts;
	}
	...
	public String retrieveStats() {
		...
		if (dmgStats != null) {
			...
			for (int i = 0; i < dmgStats.length; i++) {
				...
				sb.append(String.format("%n   » %s: %.2f%%", dmgStats[i].getFirst(),
						(double) dmgStats[i].getSecond() * 100));
			}
		}
		s = sb.toString();
		return s;
