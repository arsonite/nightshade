...
import debug.old.SuperReader;

public class Mind {
	// TODO: Remove limit on negative and positive end, or lock both extremes from
	...
	// TODO: Add civic conditions and group civic beliefs together in groups with
	// picking one of each group
	...
	public TeaType<TeaType<String>> DEBUG_displayAllCivicOptions() {
		return polArr;
	}
