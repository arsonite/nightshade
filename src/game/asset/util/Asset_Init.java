...
public class Asset_Init {
	...
	public final static int[] LVL() {
		return r.DEBUG_fileRegexToIntegerArray("./src/_res/raw/#!exp.txt");
	}

	public final static ArrayList<ArrayList<String>> ITEM(boolean rmvTag) {
		ArrayList<ArrayList<String>> list = r.DEBUG_fileRegexToStringArrayList("./src/_res/raw/#!itm_util.txt", false);
		if(rmvTag) {
